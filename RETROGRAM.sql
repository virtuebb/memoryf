...
CREATE TABLE TB_DM_PARTICIPANT (
    ...
    CONSTRAINT PK_DM_PARTICIPANT
        PRIMARY KEY (ROOM_NO, MEMBER_ID),

    CONSTRAINT FK_DM_PARTICIPANT_ROOM
        FOREIGN KEY (ROOM_NO)
        REFERENCES TB_DM_ROOM (ROOM_NO),

    CONSTRAINT FK_DM_PARTICIPANT_MEMBER
...
CREATE TABLE TB_DM_MESSAGE (
    ...
    CONSTRAINT FK_DM_MESSAGE_ROOM
        FOREIGN KEY (ROOM_NO)
        REFERENCES TB_DM_ROOM (ROOM_NO),

    CONSTRAINT FK_DM_MESSAGE_SENDER
