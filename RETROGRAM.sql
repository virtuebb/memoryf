...
-- DROP TABLE TB_STORY_ITEM; -- (중복 제거됨)
...
CREATE SEQUENCE SEQ_REPORT_FEED_ID START WITH 1 INCREMENT BY 1 CACHE 20;
...
CREATE SEQUENCE SEQ_DM_ROOM_ID START WITH 1 INCREMENT BY 1 CACHE 20;
CREATE SEQUENCE SEQ_DM_MESSAGE_ID START WITH 1 INCREMENT BY 1 CACHE 20;
...
CREATE SEQUENCE SEQ_REPORT_ID START WITH 1 INCREMENT BY 1 CACHE 20;
...
CREATE TABLE TB_NOTIFICATION (
    ...
    CREATE_DATE     DATE            DEFAULT SYSDATE,
    FOREIGN KEY (RECEIVER_NO) REFERENCES TB_MEMBER(MEMBER_NO),
    FOREIGN KEY (SENDER_NO) REFERENCES TB_MEMBER(MEMBER_NO)
);

--------------------------------------------------------
-- 5. DM 관련 시퀀스 재정의 (기존 SEQ_DM_ROOM_ID -> SEQ_DM_ROOM_NO로 변경)
--------------------------------------------------------
DROP SEQUENCE SEQ_DM_ROOM_ID;
DROP SEQUENCE SEQ_DM_MESSAGE_ID;
...
--------------------------------------------------------
-- 6. 초기 데이터 삽입 (테스트용 회원 데이터)
--------------------------------------------------------
-- 테스트용 회원 데이터 삽입
INSERT INTO TB_MEMBER (MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, MEMBER_NICK, EMAIL, PHONE, GENDER, BIRTHDAY, STATUS, POINT)
VALUES (SEQ_MEMBER_NO.NEXTVAL, 'testuser', '$2a$10$N7P8Yw1qU5KvQ5rKqLqLJ.nQ5Y4R8Z9Z8Y7Y6Y5Y4Y3Y2Y1Y0Y9Y8Y', '테스트유저', '테스터', 'test@test.com', '010-1234-5678', 'M', TO_DATE('1990-01-01', 'YYYY-MM-DD'), 'Y', 10000);

-- 테스트용 홈 데이터 삽입
INSERT INTO TB_MEMBER_HOME (HOME_NO, HOME_TITLE, STATUS_MSG, MEMBER_NO)
VALUES (SEQ_HOME_NO.NEXTVAL, '테스트유저의 홈', '안녕하세요!', (SELECT MEMBER_NO FROM TB_MEMBER WHERE MEMBER_ID = 'testuser'));
