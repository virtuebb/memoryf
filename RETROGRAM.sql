...
CREATE SEQUENCE SEQ_CHARGE_NO START WITH 1 INCREMENT BY 1 NOCACHE;
...
CREATE TABLE TB_PAYMENT (
    ...
    MEMBER_NO       NUMBER          NOT NULL,
    PAYMENT_TYPE    VARCHAR2(20)    DEFAULT 'BGM',
...
-- BGM 샘플 데이터 추가
INSERT INTO TB_BGM (BGM_NO, BGM_TITLE, FILE_PATH, ARTIST, PRICE, REG_DATE) 
VALUES (SEQ_BGM_NO.NEXTVAL, 'Summer Vibes', '/bgm/summer_vibes.mp3', 'DJ Cool', 1000, SYSDATE);

INSERT INTO TB_BGM (BGM_NO, BGM_TITLE, FILE_PATH, ARTIST, PRICE, REG_DATE) 
VALUES (SEQ_BGM_NO.NEXTVAL, 'City Lights', '/bgm/city_lights.mp3', 'Urban Sound', 1500, SYSDATE);

INSERT INTO TB_BGM (BGM_NO, BGM_TITLE, FILE_PATH, ARTIST, PRICE, REG_DATE) 
VALUES (SEQ_BGM_NO.NEXTVAL, 'Chill Lounge', '/bgm/chill_lounge.mp3', 'Relaxing Beats', 2000, SYSDATE);

INSERT INTO TB_BGM (BGM_NO, BGM_TITLE, FILE_PATH, ARTIST, PRICE, REG_DATE) 
VALUES (SEQ_BGM_NO.NEXTVAL, 'Retro Wave', '/bgm/retro_wave.mp3', 'Synth Masters', 2500, SYSDATE);

INSERT INTO TB_BGM (BGM_NO, BGM_TITLE, FILE_PATH, ARTIST, PRICE, REG_DATE) 
VALUES (SEQ_BGM_NO.NEXTVAL, 'Jazz Night', '/bgm/jazz_night.mp3', 'Smooth Jazz Trio', 3000, SYSDATE);
