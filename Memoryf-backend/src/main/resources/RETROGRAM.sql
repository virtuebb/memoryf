...
-- 2. 모든 테이블 삭제 (DROP TABLES - 의존성 역순)
...
-- 5. DM 대화방 테이블 (수정 전 원복: 1:1 방식)
CREATE TABLE TB_DM_ROOM (	
    ROOM_NO         NUMBER, 
	ROOM_TYPE       VARCHAR2(10 BYTE) DEFAULT 'PRIVATE', 
